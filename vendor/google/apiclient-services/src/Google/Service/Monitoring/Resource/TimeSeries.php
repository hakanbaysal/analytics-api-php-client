 ...
 *  </code>
 */
class Google_Service_Monitoring_Resource_TimeSeries extends Google_Service_Resource
{
  /**
   ...
   * Stackdriver account. (timeSeries.listTimeSeries)
   *
   * @param string $name The project on which to execute the request. The format
   * is "projects/{project_id_or_number}".
   * @param array $optParams Optional parameters.
   ...
   */
  public function listTimeSeries($name, $optParams = array())
  {
